...
public class FrameQuiz10 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        perguntaLabel10 = new javax.swing.JLabel();
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Questão 10"));

        perguntaLabel10.setText("Pergunta10");
    ...
    private void finalizaButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_finalizaButtonActionPerformed
        if (respostaq1RadioButton1.isSelected() || respostaq1RadioButton2.isSelected() || respostaq1RadioButton3.isSelected() || respostaq1RadioButton4.isSelected()){
            ...
            var dt = new FimQuiz(); //chama uma tela específicao nome para sua tentativa:
            dt.setVisible(true); //faz tal tela ser visível
            dispose(); // descarta a tela atual
        }
        else{
    ...
    private javax.swing.JLabel perguntaLabel10;
